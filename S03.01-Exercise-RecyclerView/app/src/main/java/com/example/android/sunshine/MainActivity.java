...
public class MainActivity extends AppCompatActivity {
    ...
    private ForecastAdapter m_forecastAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        m_recyclerView = (RecyclerView) findViewById(R.id.rv_forecast);
        ...
        m_forecastAdapter = new ForecastAdapter();

        // TODO (42) Use mRecyclerView.setAdapter and pass in mForecastAdapter
        m_recyclerView.setAdapter(m_forecastAdapter);
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                 ...
                 */
                m_forecastAdapter.setWeatherData(weatherData);
            } else {
                showErrorMessage();
            }
        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            ...
            m_forecastAdapter.setWeatherData(null); //?
            loadWeatherData();
            return true;
        }
